    ...
    <section id="main-content">
        <section class="wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">ویرایش محصول
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input value="" type="text" name="price"
                                                   class="form-control" placeholder="مبلغ محصول">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">شرح محصول</label>
                                        <div class="col-lg-10">
                                            <textarea name="description" class="form-control">محصول خوب </textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <select name="discount_id" class="form-control" style="height: 40px">
                                                <option value="{{null}}">تخفیف ندارد</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                                <label class="access_lvl">
                                                    <input type="checkbox" name="tags[]"> تگ پیشفرض
                                                </label>
                                                <br/>
                                        </div>
                                    </div>
